...
namespace GrupoF.Prototipo.Base_de_Datos
{
    internal class Datos_model
    {
        ...
        {
            new OrdenesDePreparacion {Id_Estado = 1, Id_OrdenDePreparacion = 1, Prioridad_OrdenDePreparacion = true, Id_Cliente = 1, Emision_OrdenDePreparacion = DateTime.Now,  Id_Mercaderia = 1, Cantidad_OrdenDePreparacion = 10, Id_Deposito = 1, Id_Transportista = 1, Id_Remito = 1},
            new OrdenesDePreparacion {Id_Estado = 2, Id_OrdenDePreparacion = 2, Prioridad_OrdenDePreparacion = true, Id_Cliente = 2, Emision_OrdenDePreparacion = DateTime.Now.AddMonths(1),  Id_Mercaderia = 2, Cantidad_OrdenDePreparacion = 20, Id_Deposito = 2, Id_Transportista = 2, Id_Remito = null},
        };
