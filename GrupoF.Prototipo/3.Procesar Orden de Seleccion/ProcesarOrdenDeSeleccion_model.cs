...
namespace GrupoF.Prototipo._3.Procesar_Orden_de_Seleccion
{
    internal class ProcesarOrdenDeSeleccion_model
    {
        ...
        {
            new OrdenesDePreparacion { Id_OrdenDePreparacion = 1, Id_EstadoOP = 2, Prioridad_OrdenDePreparacion = true, Id_Cliente = 1, Emision_OrdenDePreparacion = DateTime.Now.AddDays(1), Id_Deposito = 2, Dni_transportista = 11111111, Id_OrdenDeEntrega = null, Id_OrdenDeSeleccion = 1, Id_Remito = null },
            new OrdenesDePreparacion { Id_OrdenDePreparacion = 2, Id_EstadoOP = 2, Prioridad_OrdenDePreparacion = false, Id_Cliente = 2, Emision_OrdenDePreparacion = DateTime.Now.AddDays(2), Id_Deposito = 3, Dni_transportista = 22222222, Id_OrdenDeEntrega = null, Id_OrdenDeSeleccion = 2, Id_Remito = null },
            new OrdenesDePreparacion { Id_OrdenDePreparacion = 3, Id_EstadoOP = 2, Prioridad_OrdenDePreparacion = true, Id_Cliente = 3, Emision_OrdenDePreparacion = DateTime.Now.AddDays(3), Id_Deposito = 1, Dni_transportista = 11111111, Id_OrdenDeEntrega = null, Id_OrdenDeSeleccion = 3, Id_Remito = null },
            new OrdenesDePreparacion { Id_OrdenDePreparacion = 4, Id_EstadoOP = 2, Prioridad_OrdenDePreparacion = false, Id_Cliente = 1, Emision_OrdenDePreparacion = DateTime.Now.AddDays(4), Id_Deposito = 2, Dni_transportista = 22222222, Id_OrdenDeEntrega = null, Id_OrdenDeSeleccion = 4, Id_Remito = null },
            new OrdenesDePreparacion { Id_OrdenDePreparacion = 5, Id_EstadoOP = 2, Prioridad_OrdenDePreparacion = true, Id_Cliente = 2, Emision_OrdenDePreparacion = DateTime.Now.AddDays(5), Id_Deposito = 3, Dni_transportista = 11111111, Id_OrdenDeEntrega = null, Id_OrdenDeSeleccion = 1, Id_Remito = null },
            new OrdenesDePreparacion { Id_OrdenDePreparacion = 6, Id_EstadoOP = 2, Prioridad_OrdenDePreparacion = false, Id_Cliente = 3, Emision_OrdenDePreparacion = DateTime.Now.AddDays(1), Id_Deposito = 1, Dni_transportista = 22222222, Id_OrdenDeEntrega = null, Id_OrdenDeSeleccion = 2, Id_Remito = null },
            new OrdenesDePreparacion { Id_OrdenDePreparacion = 7, Id_EstadoOP = 2, Prioridad_OrdenDePreparacion = true, Id_Cliente = 1, Emision_OrdenDePreparacion = DateTime.Now.AddDays(2), Id_Deposito = 2, Dni_transportista = 11111111, Id_OrdenDeEntrega = null, Id_OrdenDeSeleccion = 3, Id_Remito = null },
            new OrdenesDePreparacion { Id_OrdenDePreparacion = 8, Id_EstadoOP = 2, Prioridad_OrdenDePreparacion = false, Id_Cliente = 2, Emision_OrdenDePreparacion = DateTime.Now.AddDays(3), Id_Deposito = 3, Dni_transportista = 22222222, Id_OrdenDeEntrega = null, Id_OrdenDeSeleccion = 4, Id_Remito = null },
            new OrdenesDePreparacion { Id_OrdenDePreparacion = 9, Id_EstadoOP = 2, Prioridad_OrdenDePreparacion = true, Id_Cliente = 3, Emision_OrdenDePreparacion = DateTime.Now.AddDays(4), Id_Deposito = 1, Dni_transportista = 11111111, Id_OrdenDeEntrega = null, Id_OrdenDeSeleccion = 1, Id_Remito = null },
            new OrdenesDePreparacion { Id_OrdenDePreparacion = 10, Id_EstadoOP = 2, Prioridad_OrdenDePreparacion = false, Id_Cliente = 1, Emision_OrdenDePreparacion = DateTime.Now.AddDays(5), Id_Deposito = 2, Dni_transportista = 22222222, Id_OrdenDeEntrega = null, Id_OrdenDeSeleccion = 2, Id_Remito = null },
            new OrdenesDePreparacion { Id_OrdenDePreparacion = 11, Id_EstadoOP = 2, Prioridad_OrdenDePreparacion = true, Id_Cliente = 2, Emision_OrdenDePreparacion = DateTime.Now.AddDays(1), Id_Deposito = 3, Dni_transportista = 11111111, Id_OrdenDeEntrega = null, Id_OrdenDeSeleccion = 3, Id_Remito = null },
        };
        ...
        {
            var ordenesDeSeleccion = OrdenesDeSeleccion.Where(x => x.Id_OrdenDeSeleccion == id).SingleOrDefault();

            ordenesDeSeleccion.Id_EstadoOS = 2;
